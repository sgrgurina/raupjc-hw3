...
namespace Zadatak1
{
    public class TodoSqlRepository : ITodoRepository
    {
        ...
        public TodoLabel GetLabel(string value)
        {
            TodoLabel label = _context.TodoLabels.FirstOrDefault(l => l.Value == value);
            return label;
        }
        ...
        public void AddLabel(TodoLabel todoLabel)
        {
            TodoLabel label = _context.TodoLabels.FirstOrDefault(l => l.Id == todoLabel.Id);
            if (label != null)
            {
                throw new DuplicateTodoLabelException("duplicate label id: {id}");
            }
